...
dir <- './inst/extdata/159922_2020_196385/'
...
etuff <- tag_to_etuff(dir, meta_row, gpe3=TRUE)
...
## check the meta hdr
etuff_file <- paste(dir, etuff$meta$instrument_name, '_eTUFF.txt', sep='')
...
ggplot(srss) + geom_rect(aes(xmin=sunrise, xmax=sunset, ymin=-650, ymax=0), alpha=0.25, colour='grey') +
